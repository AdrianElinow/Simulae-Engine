...
from NGIN.ai.lib.simulae_actor import SimulaeActor
from NGIN.ai.lib.socialization_constants import (
    SOCIAL_INTERACTION_TYPES,
)
from NGIN.ai.lib.socialization_utils import generate_person
from NGIN.implementation.lib.SimulaeNode import PERSONALITY, POLICY
...
class TestNGINSocialization(unittest.TestCase):
    ...
    def _build_actor(self, name):
        actor = SimulaeActor(generate_person())
